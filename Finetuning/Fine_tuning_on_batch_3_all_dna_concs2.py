...
for this_index, this_group_of_names in enumerate(groups_of_ordered_groups):
    ...
    sampler, pid = py_inference(Model = M,
                                exp_data = groups_of_expt_data[this_index], 
                                measurements = ['GFP'], 
                                time_column = ['Time (sec)'],
                                initial_conditions = groups_of_initial_conditions[this_index],
                                nwalkers = nwalkers, 
                                nsteps = nsteps, 
                                init_seed = init_seed,
    ...
    filename_for_sampler_pid_export = f'../Inference_Results/Sampler_and_PID_Objects/Expt_Batch_3_all_dna_concs2/' + filename_for_export
    filename_for_image_export = f'../Inference_Results/Plots/Expt_Batch_3_all_dna_concs2/' + filename_for_export + '.png'
...
filename_for_mase_dict_export = f'../Inference_Results/MASE_Values/mase_dict_expt_batch_3_all_dna_concs2.pickle'
