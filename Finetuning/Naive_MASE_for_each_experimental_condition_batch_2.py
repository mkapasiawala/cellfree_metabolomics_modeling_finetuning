...
# COMPUTE MASE VALUES FOR EACH EXPT CONDITION
...
for this_index, this_name in enumerate(ordered_groups_of_interest):
    ...
    mase_value = compute_naive_mase_value_single_initial_condition(M, 
                                                                    initial_conditions[this_index], 
                                                                    exp_data[this_index],
                                                                    )

    # save mase values
    mase_dict[filename_for_export] = mase_value

# save dictionary of mase values
filename_for_mase_dict_export = f'../Inference_Results/MASE_Values/mase_dict_expt_batch_2_naive.pickle'
