...
#SBATCH -J "Batch_2_1000"   # whatever job name
...
/home/mkapasia/anaconda3/envs/modeling_3.12/bin/python /resnick/groups/murray-biocircuits/mkapasia/Finetuning/Python_Scripts/Fine_tuning_on_each_experimental_condition_separately_batch_2_fewer_steps/Fine_tuning_on_each_experimental_condition_separately_batch_2_1000_steps.py
