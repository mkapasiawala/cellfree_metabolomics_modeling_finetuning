...
#SBATCH --time=120:00:00   # how much time you want in hours:minutes:seconds
#SBATCH --ntasks=28   # number of processor cores (i.e. tasks)
#SBATCH --nodes=1   # number of nodes
#SBATCH --mem-per-cpu=4G   # memory per CPU core
#SBATCH -J "Fine_tuning_on_batch_3_only_4_dna_concs"   # whatever job name
...
/home/mkapasia/anaconda3/envs/modeling_3.12/bin/python /central/groups/murray-biocircuits/mkapasia/Finetuning/Python_Scripts/Fine_tuning_on_batch_3_only_4_dna_concs.py
