...
for this_index, this_group_of_names in enumerate(groups_of_ordered_groups):
    ...
    filename_for_sampler_pid_export = f'../Finetuning/Inference_Results/Sampler_and_PID_Objects/Expt_Batch_3_all_dna_concs2/' + filename_for_export
    filename_for_image_export = f'../Finetuning/Inference_Results/Plots/Expt_Batch_3_all_dna_concs2/' + filename_for_export + '.png'
    ...
    # plot data
    img_save = f'../Figures/FigSD/{filename_for_export}.png' 
